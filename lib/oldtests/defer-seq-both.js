...
test = new Test('defer-sequence-create-and-resolve', iterations);
...
function runTest(name, lib) {
    ...
    // We wait till after the chain is fully formed to gaurantee libraries weren't able to take any shortcuts
    d.fulfill(0)
